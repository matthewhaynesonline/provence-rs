...
Rust _inference_ implementation with [Hugging Face Candle](https://github.com/huggingface/candle) of the [Provence Reranker model](https://huggingface.co/naver/provence-reranker-debertav3-v1).

Background: https://github.com/huggingface/candle/pull/3191

## Important Provence License Info

**[NOTE: the Provence model weights are CC-BY-NC-ND-4.0](https://huggingface.co/naver/provence-reranker-debertav3-v1/blob/main/Provence_LICENSE.txt)**. **This repository contains only inference code.** It does not include any model weights.

If you use this code with the **Provence** model weights, note that those weights are subject to a [CC BY-NC-ND 4.0 license](https://huggingface.co/naver/provence-reranker-debertav3-v1/blob/main/Provence_LICENSE.txt).
